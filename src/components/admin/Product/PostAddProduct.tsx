...
const PostAddProduct = () => {
  const { register, handleSubmit, formState: { errors }, watch } = useForm<IProduct>({
    defaultValues: { score: 0, parent: 0, type: "simple", album: [], price: 1, quantity: 1 }
  });
  ...
  const onSubmit = async (data: IProduct) => {
    ...
    // build variants with id=index+1
